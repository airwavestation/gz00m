            ...
            {isStreamingOpen && (
              <div className="mt-4 grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <span className="relative z-10 text-sm font-bold px-3 py-1 rounded" style={{ color: '#00FF00', backgroundColor: '#1E1E1E' }}>YouTube</span>
                </a>
                ...
                >
                  ...
                  <span className="relative z-10 text-sm font-bold px-3 py-1 rounded" style={{ color: '#00FF00', backgroundColor: '#1E1E1E' }}>Spotify</span>
                </a>
                ...
                >
                  ...
                  <span className="relative z-10 text-sm font-bold px-3 py-1 rounded" style={{ color: '#00FF00', backgroundColor: '#1E1E1E' }}>Tidal</span>
                </a>
                ...
                >
                  ...
                  <span className="relative z-10 text-sm font-bold px-3 py-1 rounded" style={{ color: '#00FF00', backgroundColor: '#1E1E1E' }}>Apple Music</span>
                </a>
              </div>
            )}
          </div>
